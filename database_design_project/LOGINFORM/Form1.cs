...
namespace LOGINFORM
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            skinEngine1.SkinFile = Application.StartupPath + @"\OneCyan.ssk";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string str = "Server=localhost;User ID=root;Password=979268;Database=project;CharSet=gbk";
            ...
            if(fla==0)
                ...
                if(flag==0)
                {
                    MessageBox.Show("用户名或密码错误，请重新输入密码");
                    textBox2.Text = "";
                }
            }
        }
